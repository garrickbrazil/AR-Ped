...
for d=1:length(dataNames), dataName=dataNames{d};
  ...
  if(any(strcmpi(dataName,{'InriaTest','TudBrussels','ETH', 'kittitest', 'kitti_fold1', 'kitti_fold2', 'kitti_fold3', 'citytest'})))
  ...
  plotName=['external/caltech_toolbox/results/' dataName];
