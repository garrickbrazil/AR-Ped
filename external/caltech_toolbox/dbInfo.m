...
switch name1
  ...
  case 'usatrain_new' % Caltech Pedestrian Datasets (training)
    setIds=0:5; subdir='USA_new'; skip=30; ext='jpg';
    vidIds={0:14 0:5 0:11 0:12 0:11 0:12};
  case 'usatrainval' % Caltech Pedestrian Datasets (training/val)
    setIds=0:5; subdir='USA'; skip=120; ext='jpg';
    vidIds={0:14 0:5 0:11 0:12 0:11 0:12};
  ...
  case 'usatest_new' % Caltech Pedestrian Datasets (testing)
    setIds=6:10; subdir='USA_new'; skip=30; ext='jpg';
    vidIds={0:18 0:11 0:10 0:11 0:11};
  case 'kittitest'
    setIds=2; subdir='KITTI'; skip=1; ext='jpg'; vidIds={0};
  case 'citytest'
    setIds=0; subdir='Citypersons'; skip=1; ext='jpg'; vidIds={0};
